...
El diccionario de señas se dimensionó para alojar entre 150 y 200 entradas: las 30 letras
del alfabeto dactilológico, las 50 señas dinámicas del vocabulario del Modelo B, y señas
adicionales de vocabulario común agrupadas por categorías, como números, colores,
vínculos familiares, emociones, entorno escolar y necesidades básicas.

La versión entregada incorpora el alfabeto dactilológico completo, que es lo que habilita
el respaldo de deletreo y permite representar cualquier palabra, junto con un conjunto
inicial de señas de palabra completa. Grabar las entradas restantes es un trabajo de
captura que no exige cambios en el sistema, porque el formato del clip y el mecanismo de
consulta ya están definidos y en funcionamiento: cada entrada nueva se agrega al índice
del diccionario sin tocar el código de reproducción. La ampliación del diccionario se
plantea, por tanto, como parte del trabajo futuro.
