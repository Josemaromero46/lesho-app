...
Para documentar la participación de los colaboradores se elaboraron una hoja de
información y un consentimiento informado, conforme a los principios éticos
internacionales aplicables a la investigación con seres humanos. El consentimiento
distingue de forma separada la participación en el estudio, la publicación del conjunto
de datos bajo seudónimo y el uso de fotografías de las sesiones, de manera que cada
persona pueda autorizar unas y no otras. Antes de cada sesión se explicó a las personas
participantes el propósito del estudio, el tratamiento local de los datos y su derecho a
no participar.
