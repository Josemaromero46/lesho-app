...
\begin{itemize}
    ...
    \item \textbf{Aplicar la evaluación de usabilidad con la fundación:} llevar a cabo las sesiones con personas adultas y con niños sordos, usando los instrumentos ya diseñados, para complementar la evaluación técnica con la percepción de los usuarios finales.
